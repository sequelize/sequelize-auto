      ...
      _.each(fields, function(field, i){
        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            ...
            else if (self.sequelize.options.dialect === "postgres" &&  defaultVal && defaultVal.toLowerCase() === 'uuid_generate_v4()') {
              defaultVal = "Sequelize.UUIDV4"; // disable adding "default value" attribute for UUID fields if generating for MS SQL
            }    

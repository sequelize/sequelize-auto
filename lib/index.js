        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            if (isSerialKey) {
             ...
             if (self.tables[table][field][attr] === true && (! _.has(self.tables[table][field], 'foreignKey') || (_.has(self.tables[table][field], 'foreignKey') && (!! self.tables[table][field].foreignKey.isPrimaryKey || self.tables[table][field].foreignKey.target_column === null))))

...
AutoSequelize.prototype.build = function(callback) {
  ...
  function processTables(tables) {
    function compareFn(a, b) {
      if (a.table_name && b.table_name && a.table_schema && b.table_schema) {
        return a.table_name === b.table_name && a.table_schema === b.table_schema;
      }

      const aName = a.table_name !== undefined ? a.table_name : a;
      const bName = b.table_name !== undefined ? b.table_name : b;

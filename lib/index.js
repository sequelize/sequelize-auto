      ...
      _.each(fields, function(field, i){
        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            ...
            if (self.sequelize.options.dialect === "postgres" &&  _.isString(defaultVal) && defaultVal.toLowerCase() === 'uuid_generate_v4()') {
            ...
            if (_.isString(defaultVal)) {
              ...
              } else if (!val_text.match(/^DataTypes/)) {
                val_text = quoteWrapper + val_text + quoteWrapper
              }
            }
            ...
            if(defaultVal === null || defaultVal === undefined) {
              ...
              val_text = _.isString(val_text) && !val_text.match(/^DataTypes/) && !val_text.match(/^sequelize\.[^(]+\(.*\)$/) ? SqlString.escape(_.trim(val_text, '"'), null, self.options.dialect) : val_text;
            ...
            if (_attr === "boolean" || _attr === "bit(1)" || _attr === "bit") {
              ...
              // TODO: add support for array params (datatypes)
              val = 'DataTypes.ARRAY';
            }

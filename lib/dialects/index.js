...
exports.mysql = {
  ...
  getTablesInfoQuery: function (schemaName) {
    return `SELECT TABLE_COMMENT as comment,TABLE_NAME as tablename FROM INFORMATION_SCHEMA.TABLES  WHERE TABLE_SCHEMA = '${schemaName}'`
  }
};
